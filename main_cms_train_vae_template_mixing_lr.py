...
trainer = tra.Trainer(optimizer=optimizer, beta=params.beta, patience=3, min_delta=0.03, max_lr_decay=params.max_lr_decay, lambda_reg=params.lambda_reg, annealing=False, datalength=params.train_total_n, batchsize=params.batch_n, lr_decay_factor=0.9)
