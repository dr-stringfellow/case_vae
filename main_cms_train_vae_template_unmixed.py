...
data_train_generator = dage.CaseDataGenerator(path=paths.sample_dir_path('qcdSigTrainSB'), sample_part_n=params.gen_part_n, sample_max_n=params.train_total_n, **cuts.global_cuts) # generate 10 M jet samples
...
print(paths.sample_dir_path('qcdSigTestSB'))
const_valid, _, features_valid, _, truth_valid = dare.CaseDataReader(path=paths.sample_dir_path('qcdSigTestSB')).read_events_from_dir(max_n=params.valid_total_n, **cuts.global_cuts)
